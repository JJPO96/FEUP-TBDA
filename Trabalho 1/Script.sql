...
DROP INDEX CODIGO_AULAS;
CREATE INDEX CODIGO_AULAS ON ZTIPOSAULA (CODIGO);

DROP INDEX ANO_AULAS;
CREATE INDEX ANO_AULAS ON ZTIPOSAULA (ANO_LETIVO);

DROP INDEX TIPO_AULAS;
CREATE INDEX TIPO_AULAS ON ZTIPOSAULA (TIPO);
